    ...
    methods: {
        register() {
            ...
            axios.post("/api/v1/web/registration/visitor", {
                ...
                company: this.form.title,
                job_title: this.form.title,
                address: this.form.title,
                state: this.form.title,
                country: this.form.title,
                telephone: this.form.title,
                mobile_phone: this.form.title,
                fax: this.form.title,
                email: this.form.title,
                business_type: this.form.title,
                job_function: this.form.title,
                job_function_other: this.form.title,
                visit_purpose: this.form.title,
                visit_purpose_other: this.form.title,
                purchasing_role: this.form.title,
                purchasing_role_other: this.form.title,
                event_find: this.form.title,
                event_find_other: this.form.title,
                is_received_invitation_next: this.form.title,
                is_received_invitation_next_address_same: this.form.title,
                received_invitation_next_address: this.form.title,
                first_name: this.form.title,
                last_name: this.form.title,
                company_type: this.form.title,
                company_type_other: this.form.title,
                line_of_business: this.form.title,
                city: this.form.title,
                is_receive_news_letter: this.form.title,
                is_agree_policy: this.form.title,
                job_level: this.form.title,
                job_level_other: this.form.title,
                departement: this.form.title,
                departement_other: this.form.title,
                website: this.form.title,
                HowKnow: this.form.title,
            }).then(res => {
