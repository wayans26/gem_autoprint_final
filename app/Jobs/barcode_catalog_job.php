...
use App\Exports\barcode_catalog_export;
...
class barcode_catalog_job implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        $file = $this->filter['type'] === 'pdf' ? Excel::store(new barcode_catalog_export($this->filter), $path, 'local', MaatwebsiteExcel::MPDF) : Excel::store(new barcode_catalog_export($this->filter), $path, 'local');
