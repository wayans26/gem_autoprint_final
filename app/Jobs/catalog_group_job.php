...
class catalog_group_job implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        $file = $this->filter['type'] === 'pdf'  ? Excel::store(new catalog_group($this->filter), $path, 'local', MaatwebsiteExcel::MPDF) : Excel::store(new catalog_group($this->filter), $path, 'local');
