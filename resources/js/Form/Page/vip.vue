            ...
            <Form class="registration-form" @submit="register" :validation-schema="validate_role">
                <div class="card-body p-4 p-lg-5">
                    <div class="registration-section-heading">
                        <span class="registration-eyebrow">VIP visitor registration</span>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="registration-notice">If you have not receive the confirmation letter, please contact
                            our
                            staff
                            :</p>
                        ...
                        <br><br>
                        <p class="registration-notice">We look forward to welcoming you at {{ exhibition_detail.name }}
                        </p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button type="button" class="registration-language-switch" role="switch"
                            :aria-checked="language"
                            :aria-label="language ? 'Language: English' : 'Language: Indonesia'"
                            @click="change_language">
                            <span
                                class="registration-language-switch__option registration-language-switch__option--english"
                                :class="{ 'is-active': language }">English</span>
                            <span
                                class="registration-language-switch__option registration-language-switch__option--indonesia"
...
export default {
    ...
    data() {
        return {
            ...
            validate_role: yup.object({
                ...
                ReceivedInvitationNextAddress: yup.string().when([
                    'IsReceivedInvitationNext',
                    'IsReceivedInvitationNextAddressSame'
                ], {
                    is: (is_received, is_same_address) => is_received === "1" && is_same_address === "0",
                    then: validate_role => validate_role.required("Invitation Address Can't Be Empty!"),
                }),
            })
    ...
    methods: {
        ...
        validate_select() {
            if (!String(this.exhibition_id ?? '').trim()) {
                return false;
            }
            if (!String(this.sub_exhibition_id ?? '').trim()) {
                return false;
            }
