...
class depresiasi_supplier_export implements FromView, WithEvents, WithTitle
{
    ...
    public function view(): View
    {
        ...
        $this->data = asset::join('asset_groups', 'assets.asset_group_id', '=', 'asset_groups.id')
            ...
            ->whereNotNull('asset_purchases.supplier_id')
        ...
        $this->groupedData = $this->data
            ...
            ->map(function ($items, $supplier) use ($filter) {
        ...
        return view('Excel.depresiasi_supplier', [
    ...
    {
        return 'Depreciation By Supplier';
    }
}
