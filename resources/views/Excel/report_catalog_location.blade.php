...
<table>
    <tr>
        <td colspan="13">Catalog By Location</td>
    </tr>
    <tr>
        <td colspan="13"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="color: black;width: 350px">Location</td>
        <td style="color: black;width: 140px">Quantity</td>
        <td style="color: black;width: 140px">Price Unit</td>
        <td style="color: black;width: 140px">Sub Total</td>
        <td style="color: black;width: 350px">Description</td>
    ...
    @foreach ($data as $key => $item)
        <tr>
            ...
            <td style="color: black;width: 350px">{{ $item->location_name }}</td>
            <td style="color: black;width: 140px">{{ $item->qty }}</td>
            <td style="color: black;width: 140px">{{ $item->purchase_price }}</td>
            <td style="color: black;width: 140px">{{ $item->purchase_price * $item->qty }}</td>
            <td style="color: black;width: 350px">
