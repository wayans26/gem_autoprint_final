...
class depresiasi_location_export implements FromView, WithEvents, WithTitle
{
    ...
    public function view(): View
    {
        ...
        $this->data = asset::join('asset_groups', 'assets.asset_group_id', '=', 'asset_groups.id')
            ->join('asset_locations', 'assets.asset_location_id', '=', 'asset_locations.id')
        ...
        $this->groupedData = $this->data
            ...
            ->map(function ($items, $location) use ($filter) {
        ...
        return view('Excel.depresiasi_location', [
    ...
    {
        return 'Depreciation By Location';
    }
}
